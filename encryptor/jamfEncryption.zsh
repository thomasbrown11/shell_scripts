...
##################################################
#DIRECTIONS
#1.In Parameter box in jamf enter function output
...
#*If someone actually takes the time to run DecryptString() separately with the parameter from jamf they will get your actual basic token,
